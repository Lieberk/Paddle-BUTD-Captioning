...
def parse_opt():
    ...
    # Model settings
    parser.add_argument('--caption_model', type=str, default="updown",
                        help='updown')
    ...
    # Reward
    parser.add_argument('--cider_reward_weight', type=float, default=0.8,
                        help='The reward weight from cider')
    parser.add_argument('--bleu_reward_weight', type=float, default=0.2,
                        help='The reward weight from bleu1')

    # config
    parser.add_argument('--cfg', type=str, default='configs/updown_rl.yml',
